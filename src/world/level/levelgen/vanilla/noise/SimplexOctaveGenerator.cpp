...
SimplexOctaveGenerator::SimplexOctaveGenerator(Random& rand, int octavesCount, int sizeX, int sizeY, int sizeZ)
...
void SimplexOctaveGenerator::setScale(double scale)
{
	scaleX = scale;
	scaleY = scale;
	scaleZ = scale;
...
std::vector<double> SimplexOctaveGenerator::getFractalBrownianMotion(double x, double y, double z, double lacunarity, double persistence)
{
