...
void Tile::initExtraTiles()
{
	...
	// ============================================
	acaciaDoor = (new Tile(512, 0, Material::wood))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_WOOD)->setCategory(ItemCategory::Structures)->setDescriptionId("acaciaDoor")->setAllFacesTexture("door_acacia_lower");
	acaciaPressurePlate = (new Tile(513, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("acaciaPressurePlate")->setAllFacesTexture("planks_acacia");
	acaciaWood = (new Tile(514, 0, Material::wood))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_WOOD)->setCategory(ItemCategory::Structures)->setDescriptionId("acaciaWood")->setAllFacesTexture("stone");
	barrel = (new Tile(515, 0, Material::wood))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_WOOD)->setCategory(ItemCategory::Decorations)->setDescriptionId("barrel")->setAllFacesTexture("barrel_bottom");
	basalt = (new Tile(516, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("basalt")->setAllFacesTexture("basalt_side");
	bell = (new Tile(517, 0, Material::metal))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_METAL)->setCategory(ItemCategory::Decorations)->setDescriptionId("bell")->setAllFacesTexture("bell_side");
	blackCarpet = (new Tile(518, 0, Material::cloth))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_CLOTH)->setCategory(ItemCategory::Decorations)->setDescriptionId("blackCarpet")->setAllFacesTexture("stone");
	blackGlazedTerracotta = (new Tile(519, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("blackGlazedTerracotta")->setAllFacesTexture("stone");
	blackStainedGlass = (new Tile(520, 0, Material::glass))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_GLASS)->setCategory(ItemCategory::Decorations)->setDescriptionId("blackStainedGlass")->setAllFacesTexture("glass");
	blackstone = (new Tile(521, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("blackstone")->setAllFacesTexture("blackstone");
	blackstoneSlab = (new Tile(522, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("blackstoneSlab")->setAllFacesTexture("blackstone");
	blackstoneStairs = (new Tile(523, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("blackstoneStairs")->setAllFacesTexture("blackstone");
	blackstoneWall = (new Tile(524, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("blackstoneWall")->setAllFacesTexture("blackstone");
	blastFurnace = (new Tile(525, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("blastFurnace")->setAllFacesTexture("blast_furnace_front_off");
	blueCarpet = (new Tile(526, 0, Material::cloth))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_CLOTH)->setCategory(ItemCategory::Decorations)->setDescriptionId("blueCarpet")->setAllFacesTexture("stone");
	boneBlock = (new Tile(527, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("boneBlock")->setAllFacesTexture("bone_block_side");
	brewingStand = (new Tile(528, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("brewingStand")->setAllFacesTexture("brewing_stand");
	brickWall = (new Tile(529, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("brickWall")->setAllFacesTexture("brick");
	brownCarpet = (new Tile(530, 0, Material::cloth))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_CLOTH)->setCategory(ItemCategory::Decorations)->setDescriptionId("brownCarpet")->setAllFacesTexture("stone");
	brownStainedGlass = (new Tile(531, 0, Material::glass))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_GLASS)->setCategory(ItemCategory::Decorations)->setDescriptionId("brownStainedGlass")->setAllFacesTexture("glass");
	campfire = (new Tile(532, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("campfire")->setLightEmission(1.0f)->setAllFacesTexture("campfire");
	candle = (new Tile(533, 0, Material::plant))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_WOOD)->setCategory(ItemCategory::Decorations)->setDescriptionId("candle")->setLightEmission(3 / 16.0f)->setAllFacesTexture("candle");
	cartographyTable = (new Tile(534, 0, Material::wood))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_WOOD)->setCategory(ItemCategory::FoodArmor)->setDescriptionId("cartographyTable")->setAllFacesTexture("cartography_table_side1");
	carvedPumpkin = (new Tile(535, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("carvedPumpkin")->setAllFacesTexture("stone");
	cauldron = (new Tile(536, 0, Material::metal))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_METAL)->setCategory(ItemCategory::FoodArmor)->setDescriptionId("cauldron")->setAllFacesTexture("cauldron_side");
	chiseledDeepslate = (new Tile(537, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("chiseledDeepslate")->setAllFacesTexture("deepslate");
	chiseledPolishedBlackstone = (new Tile(538, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("chiseledPolishedBlackstone")->setAllFacesTexture("chiseled_polished_blackstone");
	chiseledSandstone = (new Tile(539, 0, Material::sand))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_SAND)->setCategory(ItemCategory::Decorations)->setDescriptionId("chiseledSandstone")->setAllFacesTexture("sand");
	chiseledStoneBricks = (new Tile(540, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("chiseledStoneBricks")->setAllFacesTexture("brick");
	chiseledTuff = (new Tile(541, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("chiseledTuff")->setAllFacesTexture("chiseled_tuff");
	chiseledTuffBricks = (new Tile(542, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("chiseledTuffBricks")->setAllFacesTexture("chiseled_tuff_bricks");
	cinnabar = (new Tile(543, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("cinnabar")->setAllFacesTexture("cinnabar");
	coalBlock = (new Tile(544, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("coalBlock")->setAllFacesTexture("coal_block");
	coarseDirt = (new Tile(545, 0, Material::dirt))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_GRAVEL)->setCategory(ItemCategory::Decorations)->setDescriptionId("coarseDirt")->setAllFacesTexture("coarse_dirt");
	cobbledDeepslateSlab = (new Tile(546, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("cobbledDeepslateSlab")->setAllFacesTexture("cobbled_deepslate");
	cobbledDeepslateStairs = (new Tile(547, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("cobbledDeepslateStairs")->setAllFacesTexture("cobbled_deepslate");
	cobbledDeepslateWall = (new Tile(548, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("cobbledDeepslateWall")->setAllFacesTexture("cobbled_deepslate");
	cobblestoneWall = (new Tile(549, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("cobblestoneWall")->setAllFacesTexture("cobblestone");
	composter = (new Tile(550, 0, Material::wood))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_WOOD)->setCategory(ItemCategory::Decorations)->setDescriptionId("composter")->setAllFacesTexture("compost");
	copperBlock = (new Tile(551, 0, Material::metal))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_METAL)->setCategory(ItemCategory::Structures)->setDescriptionId("copperBlock")->setAllFacesTexture("copper_block");
	crackedDeepslateBricks = (new Tile(552, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("crackedDeepslateBricks")->setAllFacesTexture("brick");
	crackedDeepslateTiles = (new Tile(553, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("crackedDeepslateTiles")->setAllFacesTexture("deepslate");
	crackedPolishedBlackstoneBricks = (new Tile(554, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("crackedPolishedBlackstoneBricks")->setAllFacesTexture("blackstone");
	crackedStoneBricks = (new Tile(555, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("crackedStoneBricks")->setAllFacesTexture("brick");
	cutSandstone = (new Tile(556, 0, Material::sand))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_SAND)->setCategory(ItemCategory::Decorations)->setDescriptionId("cutSandstone")->setAllFacesTexture("sand");
	cyanCarpet = (new Tile(557, 0, Material::cloth))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_CLOTH)->setCategory(ItemCategory::Decorations)->setDescriptionId("cyanCarpet")->setAllFacesTexture("stone");
	cyanGlazedTerracotta = (new Tile(558, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("cyanGlazedTerracotta")->setAllFacesTexture("stone");
	damagedAnvil = (new Tile(559, 0, Material::metal))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_METAL)->setCategory(ItemCategory::FoodArmor)->setDescriptionId("damagedAnvil")->setAllFacesTexture("stone");
	darkOakDoor = (new Tile(560, 0, Material::wood))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_WOOD)->setCategory(ItemCategory::Structures)->setDescriptionId("darkOakDoor")->setAllFacesTexture("door_dark_oak_lower");
	darkOakLog = (new Tile(561, 0, Material::wood))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_WOOD)->setCategory(ItemCategory::Decorations)->setDescriptionId("darkOakLog")->setAllFacesTexture("stripped_dark_oak_log");
	deadbush = (new FlowerTile(562, 0))->init()->setCategory(ItemCategory::Decorations)->setDescriptionId("deadbush")->setAllFacesTexture("deadbush");
	decoratedPot = (new Tile(563, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("decoratedPot")->setAllFacesTexture("decorated_pot_side");
	deepslateBrickSlab = (new Tile(564, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("deepslateBrickSlab")->setAllFacesTexture("deepslate_bricks");
	deepslateBrickStairs = (new Tile(565, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("deepslateBrickStairs")->setAllFacesTexture("deepslate_bricks");
	deepslateBrickWall = (new Tile(566, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("deepslateBrickWall")->setAllFacesTexture("deepslate_bricks");
	deepslateTileDoubleSlab = (new Tile(567, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("deepslateTileDoubleSlab")->setAllFacesTexture("deepslate_tiles");
	deepslateTileSlab = (new Tile(568, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("deepslateTileSlab")->setAllFacesTexture("deepslate_tiles");
	deepslateTileStairs = (new Tile(569, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("deepslateTileStairs")->setAllFacesTexture("deepslate_tiles");
	deepslateTileWall = (new Tile(570, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("deepslateTileWall")->setAllFacesTexture("deepslate_tiles");
	dioriteDoubleSlab = (new Tile(571, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("dioriteDoubleSlab")->setAllFacesTexture("stone_diorite");
	dioriteStairs = (new Tile(572, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("dioriteStairs")->setAllFacesTexture("stone_diorite");
	dioriteWall = (new Tile(573, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("dioriteWall")->setAllFacesTexture("stone_diorite");
	dragonHead = (new Tile(574, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("dragonHead")->setAllFacesTexture("stone");
	endBricks = (new Tile(575, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("endBricks")->setAllFacesTexture("end_bricks");
	endRod = (new Tile(576, 0, Material::glass))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_GLASS)->setCategory(ItemCategory::Decorations)->setDescriptionId("endRod")->setLightEmission(14 / 16.0f)->setAllFacesTexture("end_rod");
	enderChest = (new Tile(577, 0, Material::wood))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_WOOD)->setCategory(ItemCategory::FoodArmor)->setDescriptionId("enderChest")->setAllFacesTexture("ender_chest_front");
	fern = (new FlowerTile(578, 0))->init()->setCategory(ItemCategory::Decorations)->setDescriptionId("fern")->setAllFacesTexture("fern");
	fletchingTable = (new Tile(579, 0, Material::wood))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_WOOD)->setCategory(ItemCategory::FoodArmor)->setDescriptionId("fletchingTable")->setAllFacesTexture("fletching_table_front");
	flowerPot = (new FlowerTile(580, 0))->init()->setCategory(ItemCategory::Decorations)->setDescriptionId("flowerPot")->setAllFacesTexture("flower_pot");
	gildedBlackstone = (new Tile(581, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("gildedBlackstone")->setAllFacesTexture("gilded_blackstone");
	graniteStairs = (new Tile(582, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("graniteStairs")->setAllFacesTexture("stone_granite");
	graniteWall = (new Tile(583, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("graniteWall")->setAllFacesTexture("stone_granite");
	grassPath = (new Tile(584, 0, Material::dirt))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_GRAVEL)->setCategory(ItemCategory::Decorations)->setDescriptionId("grassPath")->setAllFacesTexture("grass_path_side");
	grayCarpet = (new Tile(585, 0, Material::cloth))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_CLOTH)->setCategory(ItemCategory::Decorations)->setDescriptionId("grayCarpet")->setAllFacesTexture("stone");
	greenCarpet = (new Tile(586, 0, Material::cloth))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_CLOTH)->setCategory(ItemCategory::Decorations)->setDescriptionId("greenCarpet")->setAllFacesTexture("stone");
	grindstone = (new Tile(587, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("grindstone")->setAllFacesTexture("grindstone_pivot");
	hayBlock = (new Tile(588, 0, Material::plant))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_GRASS)->setCategory(ItemCategory::Decorations)->setDescriptionId("hayBlock")->setAllFacesTexture("hay_block_side");
	hopper = (new Tile(589, 0, Material::metal))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_METAL)->setCategory(ItemCategory::FoodArmor)->setDescriptionId("hopper")->setAllFacesTexture("hopper_top");
	infestedChiseledStoneBricks = (new Tile(590, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("infestedChiseledStoneBricks")->setAllFacesTexture("brick");
	infestedCobblestone = (new Tile(591, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("infestedCobblestone")->setAllFacesTexture("cobblestone");
	infestedMossyStoneBricks = (new Tile(592, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("infestedMossyStoneBricks")->setAllFacesTexture("brick");
	infestedStoneBricks = (new Tile(593, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("infestedStoneBricks")->setAllFacesTexture("brick");
	ironBars = (new Tile(594, 0, Material::metal))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_METAL)->setCategory(ItemCategory::Structures)->setDescriptionId("ironBars")->setAllFacesTexture("iron_bars");
	ironChain = (new Tile(595, 0, Material::metal))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_METAL)->setCategory(ItemCategory::Decorations)->setDescriptionId("ironChain")->setAllFacesTexture("chain");
	ironTrapdoor = (new Tile(596, 0, Material::wood))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_WOOD)->setCategory(ItemCategory::Structures)->setDescriptionId("ironTrapdoor")->setAllFacesTexture("iron_trapdoor");
	jigsaw = (new Tile(597, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("jigsaw")->setAllFacesTexture("jigsaw_side");
	jungleButton = (new Tile(598, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("jungleButton")->setAllFacesTexture("stone");
	jungleDoor = (new Tile(599, 0, Material::wood))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_WOOD)->setCategory(ItemCategory::Structures)->setDescriptionId("jungleDoor")->setAllFacesTexture("door_jungle_lower");
	jungleTrapdoor = (new Tile(600, 0, Material::wood))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_WOOD)->setCategory(ItemCategory::Structures)->setDescriptionId("jungleTrapdoor")->setAllFacesTexture("jungle_trapdoor");
	lantern = (new Tile(601, 0, Material::metal))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_METAL)->setCategory(ItemCategory::Decorations)->setDescriptionId("lantern")->setLightEmission(1.0f)->setAllFacesTexture("lantern");
	largeFern = (new FlowerTile(602, 0))->init()->setCategory(ItemCategory::Decorations)->setDescriptionId("largeFern")->setAllFacesTexture("double_plant_fern_top");
	lectern = (new Tile(603, 0, Material::wood))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_WOOD)->setCategory(ItemCategory::FoodArmor)->setDescriptionId("lectern")->setAllFacesTexture("lectern_base");
	lightBlueCarpet = (new Tile(604, 0, Material::cloth))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_CLOTH)->setCategory(ItemCategory::Decorations)->setDescriptionId("lightBlueCarpet")->setAllFacesTexture("stone");
	lightBlueGlazedTerracotta = (new Tile(605, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("lightBlueGlazedTerracotta")->setAllFacesTexture("stone");
	lightGrayCarpet = (new Tile(606, 0, Material::cloth))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_CLOTH)->setCategory(ItemCategory::Decorations)->setDescriptionId("lightGrayCarpet")->setAllFacesTexture("stone");
	lightGrayStainedGlass = (new Tile(607, 0, Material::glass))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_GLASS)->setCategory(ItemCategory::Decorations)->setDescriptionId("lightGrayStainedGlass")->setAllFacesTexture("glass");
	limeCarpet = (new Tile(608, 0, Material::cloth))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_CLOTH)->setCategory(ItemCategory::Decorations)->setDescriptionId("limeCarpet")->setAllFacesTexture("stone");
	limeGlazedTerracotta = (new Tile(609, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("limeGlazedTerracotta")->setAllFacesTexture("stone");
	litRedstoneLamp = (new Tile(610, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("litRedstoneLamp")->setLightEmission(1.0f)->setAllFacesTexture("redstone_lamp_on");
	loom = (new Tile(611, 0, Material::wood))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_WOOD)->setCategory(ItemCategory::FoodArmor)->setDescriptionId("loom")->setAllFacesTexture("eyeblossom_blooming");
	magentaCarpet = (new Tile(612, 0, Material::cloth))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_CLOTH)->setCategory(ItemCategory::Decorations)->setDescriptionId("magentaCarpet")->setAllFacesTexture("stone");
	magentaStainedGlass = (new Tile(613, 0, Material::glass))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_GLASS)->setCategory(ItemCategory::Decorations)->setDescriptionId("magentaStainedGlass")->setAllFacesTexture("glass");
	magma = (new Tile(614, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("magma")->setLightEmission(3 / 16.0f)->setAllFacesTexture("magma");
	mangroveLeaves = (new Tile(615, 0, Material::leaves))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_GRASS)->setCategory(ItemCategory::Decorations)->setDescriptionId("mangroveLeaves")->setAllFacesTexture("mangrove_leaves");
	mangroveLog = (new Tile(616, 0, Material::wood))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_WOOD)->setCategory(ItemCategory::Decorations)->setDescriptionId("mangroveLog")->setAllFacesTexture("mangrove_log_side");
	mangroveRoots = (new Tile(617, 0, Material::wood))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_WOOD)->setCategory(ItemCategory::Structures)->setDescriptionId("mangroveRoots")->setAllFacesTexture("mangrove_roots_side");
	mangroveWood = (new Tile(618, 0, Material::wood))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_WOOD)->setCategory(ItemCategory::Structures)->setDescriptionId("mangroveWood")->setAllFacesTexture("stone");
	mossBlock = (new Tile(619, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("mossBlock")->setAllFacesTexture("moss_block");
	mossCarpet = (new Tile(620, 0, Material::cloth))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_CLOTH)->setCategory(ItemCategory::Decorations)->setDescriptionId("mossCarpet")->setAllFacesTexture("pale_moss_carpet_side_base");
	mossyCobblestoneSlab = (new Tile(621, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("mossyCobblestoneSlab")->setAllFacesTexture("mossy_cobblestone");
	mossyCobblestoneStairs = (new Tile(622, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("mossyCobblestoneStairs")->setAllFacesTexture("mossy_cobblestone");
	mossyCobblestoneWall = (new Tile(623, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("mossyCobblestoneWall")->setAllFacesTexture("mossy_cobblestone");
	mossyStoneBricks = (new Tile(624, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("mossyStoneBricks")->setAllFacesTexture("brick");
	mud = (new Tile(625, 0, Material::dirt))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_GRAVEL)->setCategory(ItemCategory::Decorations)->setDescriptionId("mud")->setAllFacesTexture("mud");
	mudBrickSlab = (new Tile(626, 0, Material::dirt))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_GRAVEL)->setCategory(ItemCategory::Decorations)->setDescriptionId("mudBrickSlab")->setAllFacesTexture("mud_bricks");
	mudBrickStairs = (new Tile(627, 0, Material::dirt))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_GRAVEL)->setCategory(ItemCategory::Decorations)->setDescriptionId("mudBrickStairs")->setAllFacesTexture("mud_bricks");
	mudBrickWall = (new Tile(628, 0, Material::dirt))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_GRAVEL)->setCategory(ItemCategory::Decorations)->setDescriptionId("mudBrickWall")->setAllFacesTexture("mud_bricks");
	mudBricks = (new Tile(629, 0, Material::dirt))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_GRAVEL)->setCategory(ItemCategory::Decorations)->setDescriptionId("mudBricks")->setAllFacesTexture("mud_bricks");
	muddyMangroveRoots = (new Tile(630, 0, Material::wood))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_WOOD)->setCategory(ItemCategory::Structures)->setDescriptionId("muddyMangroveRoots")->setAllFacesTexture("mud");
	noteblock = (new Tile(631, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("noteblock")->setAllFacesTexture("noteblock");
	orangeCarpet = (new Tile(632, 0, Material::cloth))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_CLOTH)->setCategory(ItemCategory::Decorations)->setDescriptionId("orangeCarpet")->setAllFacesTexture("stone");
	orangeGlazedTerracotta = (new Tile(633, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("orangeGlazedTerracotta")->setAllFacesTexture("stone");
	orangeStainedGlassPane = (new Tile(634, 0, Material::glass))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_GLASS)->setCategory(ItemCategory::Structures)->setDescriptionId("orangeStainedGlassPane")->setAllFacesTexture("glass");
	oxidizedCopperTrapdoor = (new Tile(635, 0, Material::wood))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_WOOD)->setCategory(ItemCategory::Structures)->setDescriptionId("oxidizedCopperTrapdoor")->setAllFacesTexture("oxidized_copper_trapdoor");
	oxidizedCutCopper = (new Tile(636, 0, Material::metal))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_METAL)->setCategory(ItemCategory::Structures)->setDescriptionId("oxidizedCutCopper")->setAllFacesTexture("oxidized_cut_copper");
	packedMud = (new Tile(637, 0, Material::dirt))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_GRAVEL)->setCategory(ItemCategory::Decorations)->setDescriptionId("packedMud")->setAllFacesTexture("packed_mud");
	pinkCarpet = (new Tile(638, 0, Material::cloth))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_CLOTH)->setCategory(ItemCategory::Decorations)->setDescriptionId("pinkCarpet")->setAllFacesTexture("stone");
	pointedDripstone = (new Tile(639, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("pointedDripstone")->setAllFacesTexture("stone");
	polishedBasalt = (new Tile(640, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("polishedBasalt")->setAllFacesTexture("polished_basalt_side");
	polishedBlackstoneBrickStairs = (new Tile(641, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("polishedBlackstoneBrickStairs")->setAllFacesTexture("polished_blackstone_bricks");
	polishedBlackstoneBricks = (new Tile(642, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("polishedBlackstoneBricks")->setAllFacesTexture("polished_blackstone_bricks");
	polishedDeepslateSlab = (new Tile(643, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("polishedDeepslateSlab")->setAllFacesTexture("polished_deepslate");
	polishedDeepslateStairs = (new Tile(644, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("polishedDeepslateStairs")->setAllFacesTexture("polished_deepslate");
	polishedDeepslateWall = (new Tile(645, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("polishedDeepslateWall")->setAllFacesTexture("polished_deepslate");
	polishedTuff = (new Tile(646, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("polishedTuff")->setAllFacesTexture("polished_tuff");
	polishedTuffSlab = (new Tile(647, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("polishedTuffSlab")->setAllFacesTexture("polished_tuff");
	potentSulfur = (new Tile(648, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("potentSulfur")->setAllFacesTexture("potent_sulfur");
	powderSnow = (new Tile(649, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("powderSnow")->setAllFacesTexture("powder_snow");
	poweredComparator = (new Tile(650, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("poweredComparator")->setAllFacesTexture("comparator_on");
	poweredRepeater = (new Tile(651, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("poweredRepeater")->setAllFacesTexture("repeater_on");
	prismarine = (new Tile(652, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("prismarine")->setAllFacesTexture("prismarine_bricks");
	purpleCarpet = (new Tile(653, 0, Material::cloth))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_CLOTH)->setCategory(ItemCategory::Decorations)->setDescriptionId("purpleCarpet")->setAllFacesTexture("stone");
	purpleGlazedTerracotta = (new Tile(654, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("purpleGlazedTerracotta")->setAllFacesTexture("stone");
	purpurBlock = (new Tile(655, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("purpurBlock")->setAllFacesTexture("purpur_block");
	purpurPillar = (new Tile(656, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("purpurPillar")->setAllFacesTexture("purpur_pillar");
	purpurSlab = (new Tile(657, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("purpurSlab")->setAllFacesTexture("purpur_block");
	purpurStairs = (new Tile(658, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("purpurStairs")->setAllFacesTexture("purpur_block");
	redCandle = (new Tile(659, 0, Material::plant))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_WOOD)->setCategory(ItemCategory::Decorations)->setDescriptionId("redCandle")->setLightEmission(3 / 16.0f)->setAllFacesTexture("red_candle");
	redCarpet = (new Tile(660, 0, Material::cloth))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_CLOTH)->setCategory(ItemCategory::Decorations)->setDescriptionId("redCarpet")->setAllFacesTexture("stone");
	redConcrete = (new Tile(661, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("redConcrete")->setAllFacesTexture("stone");
	redGlazedTerracotta = (new Tile(662, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("redGlazedTerracotta")->setAllFacesTexture("stone");
	redstoneBlock = (new Tile(663, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("redstoneBlock")->setAllFacesTexture("redstone_block");
	redstoneLamp = (new Tile(664, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("redstoneLamp")->setAllFacesTexture("redstone_lamp_off");
	redstoneTorch = (new Tile(665, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("redstoneTorch")->setAllFacesTexture("redstone_torch_on");
	redstoneWire = (new Tile(666, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("redstoneWire")->setAllFacesTexture("redstone_dust_cross");
	reinforcedDeepslate = (new Tile(667, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("reinforcedDeepslate")->setAllFacesTexture("deepslate");
	sandstoneWall = (new Tile(668, 0, Material::sand))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_SAND)->setCategory(ItemCategory::Decorations)->setDescriptionId("sandstoneWall")->setAllFacesTexture("sandstone_normal");
	sculkSensor = (new Tile(669, 0, Material::plant))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_GRASS)->setCategory(ItemCategory::Decorations)->setDescriptionId("sculkSensor")->setLightEmission(1 / 16.0f)->setAllFacesTexture("calibrated_sculk_sensor_amethyst");
	seaLantern = (new Tile(670, 0, Material::metal))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_METAL)->setCategory(ItemCategory::Decorations)->setDescriptionId("seaLantern")->setLightEmission(1.0f)->setAllFacesTexture("sea_lantern");
	seaPickle = (new Tile(671, 0, Material::plant))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_GRASS)->setCategory(ItemCategory::Decorations)->setDescriptionId("seaPickle")->setLightEmission(6 / 16.0f)->setAllFacesTexture("sea_pickle");
	silverGlazedTerracotta = (new Tile(672, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("silverGlazedTerracotta")->setAllFacesTexture("stone");
	skeletonSkull = (new Tile(673, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("skeletonSkull")->setAllFacesTexture("stone");
	smithingTable = (new Tile(674, 0, Material::wood))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_WOOD)->setCategory(ItemCategory::FoodArmor)->setDescriptionId("smithingTable")->setAllFacesTexture("smithing_table_bottom");
	smoker = (new Tile(675, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("smoker")->setAllFacesTexture("smoker_bottom");
	smoothBasalt = (new Tile(676, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("smoothBasalt")->setAllFacesTexture("smooth_basalt");
	smoothQuartz = (new Tile(677, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("smoothQuartz")->setAllFacesTexture("stone");
	smoothQuartzSlab = (new Tile(678, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("smoothQuartzSlab")->setAllFacesTexture("stone");
	smoothSandstone = (new Tile(679, 0, Material::sand))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_SAND)->setCategory(ItemCategory::Decorations)->setDescriptionId("smoothSandstone")->setAllFacesTexture("smooth_sandstone");
	smoothSandstoneDoubleSlab = (new Tile(680, 0, Material::sand))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_SAND)->setCategory(ItemCategory::Decorations)->setDescriptionId("smoothSandstoneDoubleSlab")->setAllFacesTexture("sandstone_top");
	smoothSandstoneSlab = (new Tile(681, 0, Material::sand))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_SAND)->setCategory(ItemCategory::Decorations)->setDescriptionId("smoothSandstoneSlab")->setAllFacesTexture("sandstone_top");
	smoothSandstoneStairs = (new Tile(682, 0, Material::sand))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_SAND)->setCategory(ItemCategory::Decorations)->setDescriptionId("smoothSandstoneStairs")->setAllFacesTexture("sandstone_top");
	smoothStone = (new Tile(683, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("smoothStone")->setAllFacesTexture("smooth_stone");
	smoothStoneDoubleSlab = (new Tile(684, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("smoothStoneDoubleSlab")->setAllFacesTexture("smooth_stone");
	smoothStoneSlab = (new Tile(685, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("smoothStoneSlab")->setAllFacesTexture("smooth_stone");
	soulFire = (new Tile(686, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("soulFire")->setAllFacesTexture("soul_fire_0");
	soulLantern = (new Tile(687, 0, Material::metal))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_METAL)->setCategory(ItemCategory::Decorations)->setDescriptionId("soulLantern")->setLightEmission(10 / 16.0f)->setAllFacesTexture("soul_lantern");
	spruceDoor = (new Tile(688, 0, Material::wood))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_WOOD)->setCategory(ItemCategory::Structures)->setDescriptionId("spruceDoor")->setAllFacesTexture("door_spruce_lower");
	sprucePressurePlate = (new Tile(689, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("sprucePressurePlate")->setAllFacesTexture("planks_spruce");
	spruceTrapdoor = (new Tile(690, 0, Material::wood))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_WOOD)->setCategory(ItemCategory::Structures)->setDescriptionId("spruceTrapdoor")->setAllFacesTexture("spruce_trapdoor");
	spruceWallSign = (new Tile(691, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("spruceWallSign")->setAllFacesTexture("planks_spruce");
	spruceWood = (new Tile(692, 0, Material::wood))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_WOOD)->setCategory(ItemCategory::Structures)->setDescriptionId("spruceWood")->setAllFacesTexture("stone");
	stickyPiston = (new Tile(693, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("stickyPiston")->setAllFacesTexture("piston_top_sticky");
	stickyPistonArmCollision = (new Tile(694, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("stickyPistonArmCollision")->setAllFacesTexture("piston_top_sticky");
	stoneBrickWall = (new Tile(695, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("stoneBrickWall")->setAllFacesTexture("stone_brick");
	stoneButton = (new Tile(696, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("stoneButton")->setAllFacesTexture("stone");
	stonePressurePlate = (new Tile(697, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("stonePressurePlate")->setAllFacesTexture("stone");
	strippedAcaciaLog = (new Tile(698, 0, Material::wood))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_WOOD)->setCategory(ItemCategory::Decorations)->setDescriptionId("strippedAcaciaLog")->setAllFacesTexture("stripped_acacia_log");
	strippedOakLog = (new Tile(699, 0, Material::wood))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_WOOD)->setCategory(ItemCategory::Decorations)->setDescriptionId("strippedOakLog")->setAllFacesTexture("stripped_oak_log");
	strippedOakWood = (new Tile(700, 0, Material::wood))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_WOOD)->setCategory(ItemCategory::Structures)->setDescriptionId("strippedOakWood")->setAllFacesTexture("stone");
	strippedSpruceLog = (new Tile(701, 0, Material::wood))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_WOOD)->setCategory(ItemCategory::Decorations)->setDescriptionId("strippedSpruceLog")->setAllFacesTexture("stripped_spruce_log");
	strippedSpruceWood = (new Tile(702, 0, Material::wood))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_WOOD)->setCategory(ItemCategory::Structures)->setDescriptionId("strippedSpruceWood")->setAllFacesTexture("stone");
	structureBlock = (new Tile(703, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("structureBlock")->setAllFacesTexture("structure_block_corner");
	sulfur = (new Tile(704, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("sulfur")->setAllFacesTexture("sand");
	sulfurSpike = (new Tile(705, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("sulfurSpike")->setAllFacesTexture("sandstone_top");
	tallGrass = (new FlowerTile(706, 0))->init()->setCategory(ItemCategory::Decorations)->setDescriptionId("tallGrass")->setAllFacesTexture("double_plant_grass_top");
	target = (new Tile(707, 0, Material::plant))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_WOOD)->setCategory(ItemCategory::Decorations)->setDescriptionId("target")->setAllFacesTexture("target_side");
	trappedChest = (new Tile(708, 0, Material::wood))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_WOOD)->setCategory(ItemCategory::FoodArmor)->setDescriptionId("trappedChest")->setAllFacesTexture("trapped_chest_front");
	trialSpawner = (new Tile(709, 0, Material::metal))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_METAL)->setCategory(ItemCategory::Decorations)->setDescriptionId("trialSpawner")->setAllFacesTexture("trial_spawner_bottom");
	tripWire = (new Tile(710, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("tripWire")->setAllFacesTexture("trip_wire");
	tripwireHook = (new Tile(711, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("tripwireHook")->setAllFacesTexture("trip_wire_source");
	tuff = (new Tile(712, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("tuff")->setAllFacesTexture("tuff");
	tuffBricks = (new Tile(713, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("tuffBricks")->setAllFacesTexture("tuff_bricks");
	unlitRedstoneTorch = (new Tile(714, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("unlitRedstoneTorch")->setLightEmission(1.0f)->setAllFacesTexture("redstone_torch_off");
	unpoweredComparator = (new Tile(715, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("unpoweredComparator")->setAllFacesTexture("comparator_off");
	unpoweredRepeater = (new Tile(716, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("unpoweredRepeater")->setAllFacesTexture("repeater_off");
	vault = (new Tile(717, 0, Material::metal))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_METAL)->setCategory(ItemCategory::Decorations)->setDescriptionId("vault")->setAllFacesTexture("vault_bottom");
	wallBanner = (new Tile(718, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("wallBanner")->setAllFacesTexture("wool_colored_white");
	waxedChiseledCopper = (new Tile(719, 0, Material::metal))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_METAL)->setCategory(ItemCategory::Structures)->setDescriptionId("waxedChiseledCopper")->setAllFacesTexture("chiseled_copper");
	waxedCopper = (new Tile(720, 0, Material::metal))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_METAL)->setCategory(ItemCategory::Structures)->setDescriptionId("waxedCopper")->setAllFacesTexture("waxed_copper");
	waxedCopperBulb = (new Tile(721, 0, Material::metal))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_METAL)->setCategory(ItemCategory::Structures)->setDescriptionId("waxedCopperBulb")->setLightEmission(1.0f)->setAllFacesTexture("copper_bulb");
	waxedCopperDoor = (new Tile(722, 0, Material::wood))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_WOOD)->setCategory(ItemCategory::Structures)->setDescriptionId("waxedCopperDoor")->setAllFacesTexture("copper_door_bottom");
	waxedCopperGrate = (new Tile(723, 0, Material::metal))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_METAL)->setCategory(ItemCategory::Structures)->setDescriptionId("waxedCopperGrate")->setAllFacesTexture("copper_grate");
	waxedCutCopper = (new Tile(724, 0, Material::metal))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_METAL)->setCategory(ItemCategory::Structures)->setDescriptionId("waxedCutCopper")->setAllFacesTexture("waxed_cut_copper");
	waxedCutCopperSlab = (new Tile(725, 0, Material::metal))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_METAL)->setCategory(ItemCategory::Structures)->setDescriptionId("waxedCutCopperSlab")->setAllFacesTexture("cut_copper");
	waxedCutCopperStairs = (new Tile(726, 0, Material::metal))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_METAL)->setCategory(ItemCategory::Structures)->setDescriptionId("waxedCutCopperStairs")->setAllFacesTexture("cut_copper");
	waxedOxidizedChiseledCopper = (new Tile(727, 0, Material::metal))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_METAL)->setCategory(ItemCategory::Structures)->setDescriptionId("waxedOxidizedChiseledCopper")->setAllFacesTexture("oxidized_chiseled_copper");
	waxedOxidizedCopper = (new Tile(728, 0, Material::metal))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_METAL)->setCategory(ItemCategory::Structures)->setDescriptionId("waxedOxidizedCopper")->setAllFacesTexture("oxidized_copper");
	waxedOxidizedCopperDoor = (new Tile(729, 0, Material::wood))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_WOOD)->setCategory(ItemCategory::Structures)->setDescriptionId("waxedOxidizedCopperDoor")->setAllFacesTexture("oxidized_copper_door_bottom");
	waxedOxidizedCopperGrate = (new Tile(730, 0, Material::metal))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_METAL)->setCategory(ItemCategory::Structures)->setDescriptionId("waxedOxidizedCopperGrate")->setAllFacesTexture("oxidized_copper_grate");
	waxedOxidizedCopperTrapdoor = (new Tile(731, 0, Material::wood))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_WOOD)->setCategory(ItemCategory::Structures)->setDescriptionId("waxedOxidizedCopperTrapdoor")->setAllFacesTexture("oxidized_copper_trapdoor");
	waxedOxidizedCutCopper = (new Tile(732, 0, Material::metal))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_METAL)->setCategory(ItemCategory::Structures)->setDescriptionId("waxedOxidizedCutCopper")->setAllFacesTexture("oxidized_cut_copper");
	waxedOxidizedCutCopperSlab = (new Tile(733, 0, Material::metal))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_METAL)->setCategory(ItemCategory::Structures)->setDescriptionId("waxedOxidizedCutCopperSlab")->setAllFacesTexture("oxidized_cut_copper");
	waxedOxidizedCutCopperStairs = (new Tile(734, 0, Material::metal))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_METAL)->setCategory(ItemCategory::Structures)->setDescriptionId("waxedOxidizedCutCopperStairs")->setAllFacesTexture("oxidized_cut_copper");
	whiteCandle = (new Tile(735, 0, Material::plant))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_WOOD)->setCategory(ItemCategory::Decorations)->setDescriptionId("whiteCandle")->setLightEmission(3 / 16.0f)->setAllFacesTexture("white_candle");
	whiteCarpet = (new Tile(736, 0, Material::cloth))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_CLOTH)->setCategory(ItemCategory::Decorations)->setDescriptionId("whiteCarpet")->setAllFacesTexture("stone");
	whiteConcrete = (new Tile(737, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("whiteConcrete")->setAllFacesTexture("stone");
	whiteGlazedTerracotta = (new Tile(738, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("whiteGlazedTerracotta")->setAllFacesTexture("stone");
	whiteStainedGlass = (new Tile(739, 0, Material::glass))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_GLASS)->setCategory(ItemCategory::Decorations)->setDescriptionId("whiteStainedGlass")->setAllFacesTexture("glass");
	whiteStainedGlassPane = (new Tile(740, 0, Material::glass))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_GLASS)->setCategory(ItemCategory::Structures)->setDescriptionId("whiteStainedGlassPane")->setAllFacesTexture("glass");
	woodenButton = (new Tile(741, 0, Material::wood))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_WOOD)->setCategory(ItemCategory::Structures)->setDescriptionId("woodenButton")->setAllFacesTexture("planks_oak");
	woodenPressurePlate = (new Tile(742, 0, Material::wood))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_WOOD)->setCategory(ItemCategory::Structures)->setDescriptionId("woodenPressurePlate")->setAllFacesTexture("planks_oak");
	yellowCarpet = (new Tile(743, 0, Material::cloth))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_CLOTH)->setCategory(ItemCategory::Decorations)->setDescriptionId("yellowCarpet")->setAllFacesTexture("stone");
	yellowGlazedTerracotta = (new Tile(744, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("yellowGlazedTerracotta")->setAllFacesTexture("stone");
	yellowStainedGlassPane = (new Tile(745, 0, Material::glass))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_GLASS)->setCategory(ItemCategory::Structures)->setDescriptionId("yellowStainedGlassPane")->setAllFacesTexture("glass");
}
