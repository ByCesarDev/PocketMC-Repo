...
void Tile::initExtraTiles()
{
	...
	// ============================================
	acaciaDoor = (new Tile(512, 106 | Tile::TEXTURE_ALT_FLAG, Material::wood))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_WOOD)->setCategory(ItemCategory::Structures)->setDescriptionId("acaciaDoor")->setAllFacesTexture("door_acacia_lower", 106 | Tile::TEXTURE_ALT_FLAG);
	...
	blackstoneSlab = (new Tile(522, 112 | Tile::TEXTURE_ALT_FLAG, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("blackstoneSlab")->setAllFacesTexture("blackstone", 112 | Tile::TEXTURE_ALT_FLAG);
	blackstoneStairs = (new Tile(523, 112 | Tile::TEXTURE_ALT_FLAG, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("blackstoneStairs")->setAllFacesTexture("blackstone", 112 | Tile::TEXTURE_ALT_FLAG);
	blackstoneWall = (new Tile(524, 112 | Tile::TEXTURE_ALT_FLAG, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("blackstoneWall")->setAllFacesTexture("blackstone", 112 | Tile::TEXTURE_ALT_FLAG);
	...
	brickWall = (new Tile(529, 7, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("brickWall")->setAllFacesTexture("brick", 7);
	...
	cobbledDeepslateSlab = (new Tile(546, 7 | Tile::TEXTURE_ALT_FLAG, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("cobbledDeepslateSlab")->setAllFacesTexture("cobbled_deepslate", 7 | Tile::TEXTURE_ALT_FLAG);
	cobbledDeepslateStairs = (new Tile(547, 7 | Tile::TEXTURE_ALT_FLAG, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("cobbledDeepslateStairs")->setAllFacesTexture("cobbled_deepslate", 7 | Tile::TEXTURE_ALT_FLAG);
	cobbledDeepslateWall = (new Tile(548, 7 | Tile::TEXTURE_ALT_FLAG, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("cobbledDeepslateWall")->setAllFacesTexture("cobbled_deepslate", 7 | Tile::TEXTURE_ALT_FLAG);
	cobblestoneWall = (new Tile(549, 130 | Tile::TEXTURE_ALT_FLAG, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("cobblestoneWall")->setAllFacesTexture("cobblestone", 130 | Tile::TEXTURE_ALT_FLAG);
	...
	darkOakDoor = (new Tile(560, 136 | Tile::TEXTURE_ALT_FLAG, Material::wood))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_WOOD)->setCategory(ItemCategory::Structures)->setDescriptionId("darkOakDoor")->setAllFacesTexture("door_dark_oak_lower", 136 | Tile::TEXTURE_ALT_FLAG);
	...
	deepslateBrickSlab = (new Tile(564, 20 | Tile::TEXTURE_ALT_FLAG, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("deepslateBrickSlab")->setAllFacesTexture("deepslate_bricks", 20 | Tile::TEXTURE_ALT_FLAG);
	deepslateBrickStairs = (new Tile(565, 20 | Tile::TEXTURE_ALT_FLAG, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("deepslateBrickStairs")->setAllFacesTexture("deepslate_bricks", 20 | Tile::TEXTURE_ALT_FLAG);
	deepslateBrickWall = (new Tile(566, 20 | Tile::TEXTURE_ALT_FLAG, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("deepslateBrickWall")->setAllFacesTexture("deepslate_bricks", 20 | Tile::TEXTURE_ALT_FLAG);
	...
	deepslateTileSlab = (new Tile(568, 19 | Tile::TEXTURE_ALT_FLAG, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("deepslateTileSlab")->setAllFacesTexture("deepslate_tiles", 19 | Tile::TEXTURE_ALT_FLAG);
	deepslateTileStairs = (new Tile(569, 19 | Tile::TEXTURE_ALT_FLAG, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("deepslateTileStairs")->setAllFacesTexture("deepslate_tiles", 19 | Tile::TEXTURE_ALT_FLAG);
	deepslateTileWall = (new Tile(570, 19 | Tile::TEXTURE_ALT_FLAG, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("deepslateTileWall")->setAllFacesTexture("deepslate_tiles", 19 | Tile::TEXTURE_ALT_FLAG);
	...
	dioriteStairs = (new Tile(572, 58 | Tile::TEXTURE_ALT_FLAG, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("dioriteStairs")->setAllFacesTexture("stone_diorite", 58 | Tile::TEXTURE_ALT_FLAG);
	dioriteWall = (new Tile(573, 58 | Tile::TEXTURE_ALT_FLAG, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("dioriteWall")->setAllFacesTexture("stone_diorite", 58 | Tile::TEXTURE_ALT_FLAG);
	...
	graniteStairs = (new Tile(582, 56 | Tile::TEXTURE_ALT_FLAG, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("graniteStairs")->setAllFacesTexture("stone_granite", 56 | Tile::TEXTURE_ALT_FLAG);
	graniteWall = (new Tile(583, 56 | Tile::TEXTURE_ALT_FLAG, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("graniteWall")->setAllFacesTexture("stone_granite", 56 | Tile::TEXTURE_ALT_FLAG);
	...
	ironBars = (new Tile(594, 154 | Tile::TEXTURE_ALT_FLAG, Material::metal))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_METAL)->setCategory(ItemCategory::Structures)->setDescriptionId("ironBars")->setAllFacesTexture("iron_bars", 154 | Tile::TEXTURE_ALT_FLAG);
	...
	ironTrapdoor = (new Tile(596, 156 | Tile::TEXTURE_ALT_FLAG, Material::wood))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_WOOD)->setCategory(ItemCategory::Structures)->setDescriptionId("ironTrapdoor")->setAllFacesTexture("iron_trapdoor", 156 | Tile::TEXTURE_ALT_FLAG);
	...
	jungleDoor = (new Tile(599, 158 | Tile::TEXTURE_ALT_FLAG, Material::wood))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_WOOD)->setCategory(ItemCategory::Structures)->setDescriptionId("jungleDoor")->setAllFacesTexture("door_jungle_lower", 158 | Tile::TEXTURE_ALT_FLAG);
	jungleTrapdoor = (new Tile(600, 159 | Tile::TEXTURE_ALT_FLAG, Material::wood))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_WOOD)->setCategory(ItemCategory::Structures)->setDescriptionId("jungleTrapdoor")->setAllFacesTexture("jungle_trapdoor", 159 | Tile::TEXTURE_ALT_FLAG);
	...
	mossyCobblestoneSlab = (new Tile(621, 36, Material::plant))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_GRASS)->setCategory(ItemCategory::Decorations)->setDescriptionId("mossyCobblestoneSlab")->setAllFacesTexture("mossy_cobblestone", 36);
	mossyCobblestoneStairs = (new Tile(622, 36, Material::plant))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_GRASS)->setCategory(ItemCategory::Decorations)->setDescriptionId("mossyCobblestoneStairs")->setAllFacesTexture("mossy_cobblestone", 36);
	mossyCobblestoneWall = (new Tile(623, 36, Material::plant))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_GRASS)->setCategory(ItemCategory::Decorations)->setDescriptionId("mossyCobblestoneWall")->setAllFacesTexture("mossy_cobblestone", 36);
	...
	mudBrickSlab = (new Tile(626, 178 | Tile::TEXTURE_ALT_FLAG, Material::dirt))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_GRASS)->setCategory(ItemCategory::Decorations)->setDescriptionId("mudBrickSlab")->setAllFacesTexture("mud_bricks", 178 | Tile::TEXTURE_ALT_FLAG);
	mudBrickStairs = (new Tile(627, 178 | Tile::TEXTURE_ALT_FLAG, Material::dirt))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_GRASS)->setCategory(ItemCategory::Decorations)->setDescriptionId("mudBrickStairs")->setAllFacesTexture("mud_bricks", 178 | Tile::TEXTURE_ALT_FLAG);
	mudBrickWall = (new Tile(628, 178 | Tile::TEXTURE_ALT_FLAG, Material::dirt))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_GRASS)->setCategory(ItemCategory::Decorations)->setDescriptionId("mudBrickWall")->setAllFacesTexture("mud_bricks", 178 | Tile::TEXTURE_ALT_FLAG);
	...
	orangeStainedGlassPane = (new Tile(634, 49, Material::glass))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_GLASS)->setCategory(ItemCategory::Structures)->setDescriptionId("orangeStainedGlassPane")->setAllFacesTexture("glass", 49);
	oxidizedCopperTrapdoor = (new Tile(635, 182 | Tile::TEXTURE_ALT_FLAG, Material::wood))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_WOOD)->setCategory(ItemCategory::Structures)->setDescriptionId("oxidizedCopperTrapdoor")->setAllFacesTexture("oxidized_copper_trapdoor", 182 | Tile::TEXTURE_ALT_FLAG);
	...
	polishedBlackstoneBrickStairs = (new Tile(641, 188 | Tile::TEXTURE_ALT_FLAG, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("polishedBlackstoneBrickStairs")->setAllFacesTexture("polished_blackstone_bricks", 188 | Tile::TEXTURE_ALT_FLAG);
	...
	polishedDeepslateSlab = (new Tile(643, 18 | Tile::TEXTURE_ALT_FLAG, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("polishedDeepslateSlab")->setAllFacesTexture("polished_deepslate", 18 | Tile::TEXTURE_ALT_FLAG);
	polishedDeepslateStairs = (new Tile(644, 18 | Tile::TEXTURE_ALT_FLAG, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("polishedDeepslateStairs")->setAllFacesTexture("polished_deepslate", 18 | Tile::TEXTURE_ALT_FLAG);
	polishedDeepslateWall = (new Tile(645, 18 | Tile::TEXTURE_ALT_FLAG, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("polishedDeepslateWall")->setAllFacesTexture("polished_deepslate", 18 | Tile::TEXTURE_ALT_FLAG);
	...
	polishedTuffSlab = (new Tile(647, 189 | Tile::TEXTURE_ALT_FLAG, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("polishedTuffSlab")->setAllFacesTexture("polished_tuff", 189 | Tile::TEXTURE_ALT_FLAG);
	...
	purpurSlab = (new Tile(657, 197 | Tile::TEXTURE_ALT_FLAG, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("purpurSlab")->setAllFacesTexture("purpur_block", 197 | Tile::TEXTURE_ALT_FLAG);
	purpurStairs = (new Tile(658, 197 | Tile::TEXTURE_ALT_FLAG, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("purpurStairs")->setAllFacesTexture("purpur_block", 197 | Tile::TEXTURE_ALT_FLAG);
	...
	sandstoneWall = (new Tile(668, 192, Material::sand))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_SAND)->setCategory(ItemCategory::Decorations)->setDescriptionId("sandstoneWall")->setAllFacesTexture("sandstone_normal", 192);
	...
	smoothQuartzSlab = (new Tile(678, 214 | Tile::TEXTURE_ALT_FLAG, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("smoothQuartzSlab")->setAllFacesTexture("quartz_block_bottom", 214 | Tile::TEXTURE_ALT_FLAG);
	...
	smoothSandstoneSlab = (new Tile(681, 176, Material::sand))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_SAND)->setCategory(ItemCategory::Decorations)->setDescriptionId("smoothSandstoneSlab")->setAllFacesTexture("sandstone_top", 176);
	smoothSandstoneStairs = (new Tile(682, 176, Material::sand))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_SAND)->setCategory(ItemCategory::Decorations)->setDescriptionId("smoothSandstoneStairs")->setAllFacesTexture("sandstone_top", 176);
	...
	smoothStoneSlab = (new Tile(685, 215 | Tile::TEXTURE_ALT_FLAG, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("smoothStoneSlab")->setAllFacesTexture("smooth_stone", 215 | Tile::TEXTURE_ALT_FLAG);
	...
	spruceDoor = (new Tile(688, 218 | Tile::TEXTURE_ALT_FLAG, Material::wood))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_WOOD)->setCategory(ItemCategory::Structures)->setDescriptionId("spruceDoor")->setAllFacesTexture("door_spruce_lower", 218 | Tile::TEXTURE_ALT_FLAG);
	...
	spruceTrapdoor = (new Tile(690, 219 | Tile::TEXTURE_ALT_FLAG, Material::wood))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_WOOD)->setCategory(ItemCategory::Structures)->setDescriptionId("spruceTrapdoor")->setAllFacesTexture("spruce_trapdoor", 219 | Tile::TEXTURE_ALT_FLAG);
	...
	stoneBrickWall = (new Tile(695, 16, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("stoneBrickWall")->setAllFacesTexture("stone_brick", 16);
	...
	waxedCopperDoor = (new Tile(722, 238 | Tile::TEXTURE_ALT_FLAG, Material::wood))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_WOOD)->setCategory(ItemCategory::Structures)->setDescriptionId("waxedCopperDoor")->setAllFacesTexture("copper_door_bottom", 238 | Tile::TEXTURE_ALT_FLAG);
	...
	waxedCutCopperSlab = (new Tile(725, 240 | Tile::TEXTURE_ALT_FLAG, Material::metal))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_METAL)->setCategory(ItemCategory::Structures)->setDescriptionId("waxedCutCopperSlab")->setAllFacesTexture("cut_copper", 240 | Tile::TEXTURE_ALT_FLAG);
	waxedCutCopperStairs = (new Tile(726, 240 | Tile::TEXTURE_ALT_FLAG, Material::metal))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_METAL)->setCategory(ItemCategory::Structures)->setDescriptionId("waxedCutCopperStairs")->setAllFacesTexture("cut_copper", 240 | Tile::TEXTURE_ALT_FLAG);
	...
	waxedOxidizedCopperDoor = (new Tile(729, 243 | Tile::TEXTURE_ALT_FLAG, Material::wood))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_WOOD)->setCategory(ItemCategory::Structures)->setDescriptionId("waxedOxidizedCopperDoor")->setAllFacesTexture("oxidized_copper_door_bottom", 243 | Tile::TEXTURE_ALT_FLAG);
	...
	waxedOxidizedCopperTrapdoor = (new Tile(731, 182 | Tile::TEXTURE_ALT_FLAG, Material::wood))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_WOOD)->setCategory(ItemCategory::Structures)->setDescriptionId("waxedOxidizedCopperTrapdoor")->setAllFacesTexture("oxidized_copper_trapdoor", 182 | Tile::TEXTURE_ALT_FLAG);
	...
	waxedOxidizedCutCopperSlab = (new Tile(733, 183 | Tile::TEXTURE_ALT_FLAG, Material::metal))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_METAL)->setCategory(ItemCategory::Structures)->setDescriptionId("waxedOxidizedCutCopperSlab")->setAllFacesTexture("oxidized_cut_copper", 183 | Tile::TEXTURE_ALT_FLAG);
	waxedOxidizedCutCopperStairs = (new Tile(734, 183 | Tile::TEXTURE_ALT_FLAG, Material::metal))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_METAL)->setCategory(ItemCategory::Structures)->setDescriptionId("waxedOxidizedCutCopperStairs")->setAllFacesTexture("oxidized_cut_copper", 183 | Tile::TEXTURE_ALT_FLAG);
	...
	whiteStainedGlassPane = (new Tile(740, 49, Material::glass))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_GLASS)->setCategory(ItemCategory::Structures)->setDescriptionId("whiteStainedGlassPane")->setAllFacesTexture("glass", 49);
	...
	yellowStainedGlassPane = (new Tile(745, 49, Material::glass))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_GLASS)->setCategory(ItemCategory::Structures)->setDescriptionId("yellowStainedGlassPane")->setAllFacesTexture("glass", 49);
}
