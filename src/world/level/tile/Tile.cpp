...
void Tile::initExtraTiles()
{
	...
	// ============================================
	// Bedrock Generator / Structures Block Initializations (IDs 256..491)
	// ============================================
	acaciaDoor = (new Tile(256, 0, Material::wood))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_WOOD)->setCategory(ItemCategory::Structures)->setDescriptionId("acaciaDoor")->setAllFacesTexture("door_acacia_lower");
	acaciaPressurePlate = (new Tile(257, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("acaciaPressurePlate")->setAllFacesTexture("planks_acacia");
	acaciaWood = (new Tile(258, 0, Material::wood))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_WOOD)->setCategory(ItemCategory::Structures)->setDescriptionId("acaciaWood")->setAllFacesTexture("stone");
	barrel = (new Tile(259, 0, Material::wood))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_WOOD)->setCategory(ItemCategory::Decorations)->setDescriptionId("barrel")->setAllFacesTexture("barrel_bottom");
	basalt = (new Tile(260, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("basalt")->setAllFacesTexture("basalt_side");
	bell = (new Tile(261, 0, Material::metal))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_METAL)->setCategory(ItemCategory::Decorations)->setDescriptionId("bell")->setAllFacesTexture("bell_side");
	blackCarpet = (new Tile(262, 0, Material::cloth))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_CLOTH)->setCategory(ItemCategory::Decorations)->setDescriptionId("blackCarpet")->setAllFacesTexture("stone");
	blackGlazedTerracotta = (new Tile(263, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("blackGlazedTerracotta")->setAllFacesTexture("stone");
	blackStainedGlass = (new Tile(264, 0, Material::glass))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_GLASS)->setCategory(ItemCategory::Decorations)->setDescriptionId("blackStainedGlass")->setAllFacesTexture("glass");
	blackstone = (new Tile(265, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("blackstone")->setAllFacesTexture("blackstone");
	blackstoneSlab = (new Tile(266, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("blackstoneSlab")->setAllFacesTexture("blackstone");
	blackstoneStairs = (new Tile(267, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("blackstoneStairs")->setAllFacesTexture("blackstone");
	blackstoneWall = (new Tile(268, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("blackstoneWall")->setAllFacesTexture("blackstone");
	blastFurnace = (new Tile(269, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("blastFurnace")->setAllFacesTexture("blast_furnace_front_off");
	blueCarpet = (new Tile(270, 0, Material::cloth))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_CLOTH)->setCategory(ItemCategory::Decorations)->setDescriptionId("blueCarpet")->setAllFacesTexture("stone");
	boneBlock = (new Tile(271, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("boneBlock")->setAllFacesTexture("bone_block_side");
	brewingStand = (new Tile(272, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("brewingStand")->setAllFacesTexture("brewing_stand");
	brickWall = (new Tile(273, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("brickWall")->setAllFacesTexture("brick");
	brownCarpet = (new Tile(274, 0, Material::cloth))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_CLOTH)->setCategory(ItemCategory::Decorations)->setDescriptionId("brownCarpet")->setAllFacesTexture("stone");
	brownStainedGlass = (new Tile(275, 0, Material::glass))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_GLASS)->setCategory(ItemCategory::Decorations)->setDescriptionId("brownStainedGlass")->setAllFacesTexture("glass");
	campfire = (new Tile(276, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("campfire")->setLightEmission(1.0f)->setAllFacesTexture("campfire");
	candle = (new Tile(277, 0, Material::plant))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_WOOD)->setCategory(ItemCategory::Decorations)->setDescriptionId("candle")->setLightEmission(3 / 16.0f)->setAllFacesTexture("candle");
	cartographyTable = (new Tile(278, 0, Material::wood))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_WOOD)->setCategory(ItemCategory::FoodArmor)->setDescriptionId("cartographyTable")->setAllFacesTexture("cartography_table_side1");
	carvedPumpkin = (new Tile(279, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("carvedPumpkin")->setAllFacesTexture("stone");
	cauldron = (new Tile(280, 0, Material::metal))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_METAL)->setCategory(ItemCategory::FoodArmor)->setDescriptionId("cauldron")->setAllFacesTexture("cauldron_side");
	chiseledDeepslate = (new Tile(281, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("chiseledDeepslate")->setAllFacesTexture("deepslate");
	chiseledPolishedBlackstone = (new Tile(282, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("chiseledPolishedBlackstone")->setAllFacesTexture("chiseled_polished_blackstone");
	chiseledSandstone = (new Tile(283, 0, Material::sand))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_SAND)->setCategory(ItemCategory::Decorations)->setDescriptionId("chiseledSandstone")->setAllFacesTexture("sand");
	chiseledStoneBricks = (new Tile(284, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("chiseledStoneBricks")->setAllFacesTexture("brick");
	chiseledTuff = (new Tile(285, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("chiseledTuff")->setAllFacesTexture("chiseled_tuff");
	chiseledTuffBricks = (new Tile(286, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("chiseledTuffBricks")->setAllFacesTexture("chiseled_tuff_bricks");
	cinnabar = (new Tile(287, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("cinnabar")->setAllFacesTexture("cinnabar");
	coalBlock = (new Tile(288, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("coalBlock")->setAllFacesTexture("coal_block");
	coarseDirt = (new Tile(289, 0, Material::dirt))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_GRAVEL)->setCategory(ItemCategory::Decorations)->setDescriptionId("coarseDirt")->setAllFacesTexture("coarse_dirt");
	cobbledDeepslateSlab = (new Tile(290, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("cobbledDeepslateSlab")->setAllFacesTexture("cobbled_deepslate");
	cobbledDeepslateStairs = (new Tile(291, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("cobbledDeepslateStairs")->setAllFacesTexture("cobbled_deepslate");
	cobbledDeepslateWall = (new Tile(292, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("cobbledDeepslateWall")->setAllFacesTexture("cobbled_deepslate");
	cobblestoneWall = (new Tile(293, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("cobblestoneWall")->setAllFacesTexture("cobblestone");
	composter = (new Tile(294, 0, Material::wood))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_WOOD)->setCategory(ItemCategory::Decorations)->setDescriptionId("composter")->setAllFacesTexture("compost");
	copperBlock = (new Tile(295, 0, Material::metal))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_METAL)->setCategory(ItemCategory::Structures)->setDescriptionId("copperBlock")->setAllFacesTexture("copper_block");
	crackedDeepslateBricks = (new Tile(296, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("crackedDeepslateBricks")->setAllFacesTexture("brick");
	crackedDeepslateTiles = (new Tile(297, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("crackedDeepslateTiles")->setAllFacesTexture("deepslate");
	crackedPolishedBlackstoneBricks = (new Tile(298, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("crackedPolishedBlackstoneBricks")->setAllFacesTexture("blackstone");
	crackedStoneBricks = (new Tile(299, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("crackedStoneBricks")->setAllFacesTexture("brick");
	cutSandstone = (new Tile(300, 0, Material::sand))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_SAND)->setCategory(ItemCategory::Decorations)->setDescriptionId("cutSandstone")->setAllFacesTexture("sand");
	cyanCarpet = (new Tile(301, 0, Material::cloth))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_CLOTH)->setCategory(ItemCategory::Decorations)->setDescriptionId("cyanCarpet")->setAllFacesTexture("stone");
	cyanGlazedTerracotta = (new Tile(302, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("cyanGlazedTerracotta")->setAllFacesTexture("stone");
	damagedAnvil = (new Tile(303, 0, Material::metal))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_METAL)->setCategory(ItemCategory::FoodArmor)->setDescriptionId("damagedAnvil")->setAllFacesTexture("stone");
	darkOakDoor = (new Tile(304, 0, Material::wood))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_WOOD)->setCategory(ItemCategory::Structures)->setDescriptionId("darkOakDoor")->setAllFacesTexture("door_dark_oak_lower");
	darkOakLog = (new Tile(305, 0, Material::wood))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_WOOD)->setCategory(ItemCategory::Decorations)->setDescriptionId("darkOakLog")->setAllFacesTexture("stripped_dark_oak_log");
	deadbush = (new FlowerTile(306, 0))->init()->setCategory(ItemCategory::Decorations)->setDescriptionId("deadbush")->setAllFacesTexture("deadbush");
	decoratedPot = (new Tile(307, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("decoratedPot")->setAllFacesTexture("decorated_pot_side");
	deepslateBrickSlab = (new Tile(308, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("deepslateBrickSlab")->setAllFacesTexture("deepslate_bricks");
	deepslateBrickStairs = (new Tile(309, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("deepslateBrickStairs")->setAllFacesTexture("deepslate_bricks");
	deepslateBrickWall = (new Tile(310, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("deepslateBrickWall")->setAllFacesTexture("deepslate_bricks");
	deepslateTileDoubleSlab = (new Tile(311, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("deepslateTileDoubleSlab")->setAllFacesTexture("deepslate_tiles");
	deepslateTileSlab = (new Tile(312, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("deepslateTileSlab")->setAllFacesTexture("deepslate_tiles");
	deepslateTileStairs = (new Tile(313, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("deepslateTileStairs")->setAllFacesTexture("deepslate_tiles");
	deepslateTileWall = (new Tile(314, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("deepslateTileWall")->setAllFacesTexture("deepslate_tiles");
	dioriteDoubleSlab = (new Tile(315, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("dioriteDoubleSlab")->setAllFacesTexture("stone_diorite");
	dioriteStairs = (new Tile(316, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("dioriteStairs")->setAllFacesTexture("stone_diorite");
	dioriteWall = (new Tile(317, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("dioriteWall")->setAllFacesTexture("stone_diorite");
	dragonHead = (new Tile(318, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("dragonHead")->setAllFacesTexture("stone");
	endBricks = (new Tile(319, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("endBricks")->setAllFacesTexture("end_bricks");
	endRod = (new Tile(320, 0, Material::glass))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_GLASS)->setCategory(ItemCategory::Decorations)->setDescriptionId("endRod")->setLightEmission(14 / 16.0f)->setAllFacesTexture("end_rod");
	enderChest = (new Tile(321, 0, Material::wood))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_WOOD)->setCategory(ItemCategory::FoodArmor)->setDescriptionId("enderChest")->setAllFacesTexture("ender_chest_front");
	fern = (new FlowerTile(322, 0))->init()->setCategory(ItemCategory::Decorations)->setDescriptionId("fern")->setAllFacesTexture("fern");
	fletchingTable = (new Tile(323, 0, Material::wood))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_WOOD)->setCategory(ItemCategory::FoodArmor)->setDescriptionId("fletchingTable")->setAllFacesTexture("fletching_table_front");
	flowerPot = (new FlowerTile(324, 0))->init()->setCategory(ItemCategory::Decorations)->setDescriptionId("flowerPot")->setAllFacesTexture("flower_pot");
	gildedBlackstone = (new Tile(325, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("gildedBlackstone")->setAllFacesTexture("gilded_blackstone");
	graniteStairs = (new Tile(326, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("graniteStairs")->setAllFacesTexture("stone_granite");
	graniteWall = (new Tile(327, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("graniteWall")->setAllFacesTexture("stone_granite");
	grassPath = (new Tile(328, 0, Material::dirt))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_GRAVEL)->setCategory(ItemCategory::Decorations)->setDescriptionId("grassPath")->setAllFacesTexture("grass_path_side");
	grayCarpet = (new Tile(329, 0, Material::cloth))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_CLOTH)->setCategory(ItemCategory::Decorations)->setDescriptionId("grayCarpet")->setAllFacesTexture("stone");
	greenCarpet = (new Tile(330, 0, Material::cloth))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_CLOTH)->setCategory(ItemCategory::Decorations)->setDescriptionId("greenCarpet")->setAllFacesTexture("stone");
	grindstone = (new Tile(331, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("grindstone")->setAllFacesTexture("grindstone_pivot");
	hayBlock = (new Tile(332, 0, Material::plant))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_GRASS)->setCategory(ItemCategory::Decorations)->setDescriptionId("hayBlock")->setAllFacesTexture("hay_block_side");
	hopper = (new Tile(333, 0, Material::metal))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_METAL)->setCategory(ItemCategory::FoodArmor)->setDescriptionId("hopper")->setAllFacesTexture("hopper_top");
	infestedChiseledStoneBricks = (new Tile(334, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("infestedChiseledStoneBricks")->setAllFacesTexture("brick");
	infestedCobblestone = (new Tile(335, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("infestedCobblestone")->setAllFacesTexture("cobblestone");
	infestedMossyStoneBricks = (new Tile(336, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("infestedMossyStoneBricks")->setAllFacesTexture("brick");
	infestedStoneBricks = (new Tile(337, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("infestedStoneBricks")->setAllFacesTexture("brick");
	ironBars = (new Tile(338, 0, Material::metal))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_METAL)->setCategory(ItemCategory::Structures)->setDescriptionId("ironBars")->setAllFacesTexture("iron_bars");
	ironChain = (new Tile(339, 0, Material::metal))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_METAL)->setCategory(ItemCategory::Decorations)->setDescriptionId("ironChain")->setAllFacesTexture("chain");
	ironTrapdoor = (new Tile(340, 0, Material::wood))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_WOOD)->setCategory(ItemCategory::Structures)->setDescriptionId("ironTrapdoor")->setAllFacesTexture("iron_trapdoor");
	jigsaw = (new Tile(341, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("jigsaw")->setAllFacesTexture("jigsaw_side");
	jungleButton = (new Tile(342, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("jungleButton")->setAllFacesTexture("stone");
	jungleDoor = (new Tile(343, 0, Material::wood))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_WOOD)->setCategory(ItemCategory::Structures)->setDescriptionId("jungleDoor")->setAllFacesTexture("door_jungle_lower");
	jungleTrapdoor = (new Tile(344, 0, Material::wood))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_WOOD)->setCategory(ItemCategory::Structures)->setDescriptionId("jungleTrapdoor")->setAllFacesTexture("jungle_trapdoor");
	lantern = (new Tile(345, 0, Material::metal))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_METAL)->setCategory(ItemCategory::Decorations)->setDescriptionId("lantern")->setLightEmission(1.0f)->setAllFacesTexture("lantern");
	largeFern = (new FlowerTile(346, 0))->init()->setCategory(ItemCategory::Decorations)->setDescriptionId("largeFern")->setAllFacesTexture("double_plant_fern_top");
	lectern = (new Tile(347, 0, Material::wood))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_WOOD)->setCategory(ItemCategory::FoodArmor)->setDescriptionId("lectern")->setAllFacesTexture("lectern_base");
	lightBlueCarpet = (new Tile(348, 0, Material::cloth))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_CLOTH)->setCategory(ItemCategory::Decorations)->setDescriptionId("lightBlueCarpet")->setAllFacesTexture("stone");
	lightBlueGlazedTerracotta = (new Tile(349, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("lightBlueGlazedTerracotta")->setAllFacesTexture("stone");
	lightGrayCarpet = (new Tile(350, 0, Material::cloth))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_CLOTH)->setCategory(ItemCategory::Decorations)->setDescriptionId("lightGrayCarpet")->setAllFacesTexture("stone");
	lightGrayStainedGlass = (new Tile(351, 0, Material::glass))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_GLASS)->setCategory(ItemCategory::Decorations)->setDescriptionId("lightGrayStainedGlass")->setAllFacesTexture("glass");
	limeCarpet = (new Tile(352, 0, Material::cloth))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_CLOTH)->setCategory(ItemCategory::Decorations)->setDescriptionId("limeCarpet")->setAllFacesTexture("stone");
	limeGlazedTerracotta = (new Tile(353, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("limeGlazedTerracotta")->setAllFacesTexture("stone");
	litRedstoneLamp = (new Tile(354, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("litRedstoneLamp")->setLightEmission(1.0f)->setAllFacesTexture("redstone_lamp_on");
	loom = (new Tile(355, 0, Material::wood))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_WOOD)->setCategory(ItemCategory::FoodArmor)->setDescriptionId("loom")->setAllFacesTexture("eyeblossom_blooming");
	magentaCarpet = (new Tile(356, 0, Material::cloth))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_CLOTH)->setCategory(ItemCategory::Decorations)->setDescriptionId("magentaCarpet")->setAllFacesTexture("stone");
	magentaStainedGlass = (new Tile(357, 0, Material::glass))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_GLASS)->setCategory(ItemCategory::Decorations)->setDescriptionId("magentaStainedGlass")->setAllFacesTexture("glass");
	magma = (new Tile(358, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("magma")->setLightEmission(3 / 16.0f)->setAllFacesTexture("magma");
	mangroveLeaves = (new Tile(359, 0, Material::leaves))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_GRASS)->setCategory(ItemCategory::Decorations)->setDescriptionId("mangroveLeaves")->setAllFacesTexture("mangrove_leaves");
	mangroveLog = (new Tile(360, 0, Material::wood))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_WOOD)->setCategory(ItemCategory::Decorations)->setDescriptionId("mangroveLog")->setAllFacesTexture("mangrove_log_side");
	mangroveRoots = (new Tile(361, 0, Material::wood))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_WOOD)->setCategory(ItemCategory::Structures)->setDescriptionId("mangroveRoots")->setAllFacesTexture("mangrove_roots_side");
	mangroveWood = (new Tile(362, 0, Material::wood))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_WOOD)->setCategory(ItemCategory::Structures)->setDescriptionId("mangroveWood")->setAllFacesTexture("stone");
	mossBlock = (new Tile(363, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("mossBlock")->setAllFacesTexture("moss_block");
	mossCarpet = (new Tile(364, 0, Material::cloth))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_CLOTH)->setCategory(ItemCategory::Decorations)->setDescriptionId("mossCarpet")->setAllFacesTexture("pale_moss_carpet_side_base");
	mossyCobblestoneSlab = (new Tile(365, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("mossyCobblestoneSlab")->setAllFacesTexture("mossy_cobblestone");
	mossyCobblestoneStairs = (new Tile(366, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("mossyCobblestoneStairs")->setAllFacesTexture("mossy_cobblestone");
	mossyCobblestoneWall = (new Tile(367, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("mossyCobblestoneWall")->setAllFacesTexture("mossy_cobblestone");
	mossyStoneBricks = (new Tile(368, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("mossyStoneBricks")->setAllFacesTexture("brick");
	mud = (new Tile(369, 0, Material::dirt))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_GRAVEL)->setCategory(ItemCategory::Decorations)->setDescriptionId("mud")->setAllFacesTexture("mud");
	mudBrickSlab = (new Tile(370, 0, Material::dirt))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_GRAVEL)->setCategory(ItemCategory::Decorations)->setDescriptionId("mudBrickSlab")->setAllFacesTexture("mud_bricks");
	mudBrickStairs = (new Tile(371, 0, Material::dirt))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_GRAVEL)->setCategory(ItemCategory::Decorations)->setDescriptionId("mudBrickStairs")->setAllFacesTexture("mud_bricks");
	mudBrickWall = (new Tile(372, 0, Material::dirt))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_GRAVEL)->setCategory(ItemCategory::Decorations)->setDescriptionId("mudBrickWall")->setAllFacesTexture("mud_bricks");
	mudBricks = (new Tile(373, 0, Material::dirt))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_GRAVEL)->setCategory(ItemCategory::Decorations)->setDescriptionId("mudBricks")->setAllFacesTexture("mud_bricks");
	muddyMangroveRoots = (new Tile(374, 0, Material::wood))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_WOOD)->setCategory(ItemCategory::Structures)->setDescriptionId("muddyMangroveRoots")->setAllFacesTexture("mud");
	noteblock = (new Tile(375, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("noteblock")->setAllFacesTexture("noteblock");
	orangeCarpet = (new Tile(376, 0, Material::cloth))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_CLOTH)->setCategory(ItemCategory::Decorations)->setDescriptionId("orangeCarpet")->setAllFacesTexture("stone");
	orangeGlazedTerracotta = (new Tile(377, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("orangeGlazedTerracotta")->setAllFacesTexture("stone");
	orangeStainedGlassPane = (new Tile(378, 0, Material::glass))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_GLASS)->setCategory(ItemCategory::Structures)->setDescriptionId("orangeStainedGlassPane")->setAllFacesTexture("glass");
	oxidizedCopperTrapdoor = (new Tile(379, 0, Material::wood))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_WOOD)->setCategory(ItemCategory::Structures)->setDescriptionId("oxidizedCopperTrapdoor")->setAllFacesTexture("oxidized_copper_trapdoor");
	oxidizedCutCopper = (new Tile(380, 0, Material::metal))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_METAL)->setCategory(ItemCategory::Structures)->setDescriptionId("oxidizedCutCopper")->setAllFacesTexture("oxidized_cut_copper");
	packedMud = (new Tile(381, 0, Material::dirt))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_GRAVEL)->setCategory(ItemCategory::Decorations)->setDescriptionId("packedMud")->setAllFacesTexture("packed_mud");
	pinkCarpet = (new Tile(382, 0, Material::cloth))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_CLOTH)->setCategory(ItemCategory::Decorations)->setDescriptionId("pinkCarpet")->setAllFacesTexture("stone");
	pointedDripstone = (new Tile(383, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("pointedDripstone")->setAllFacesTexture("stone");
	polishedBasalt = (new Tile(384, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("polishedBasalt")->setAllFacesTexture("polished_basalt_side");
	polishedBlackstoneBrickStairs = (new Tile(385, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("polishedBlackstoneBrickStairs")->setAllFacesTexture("polished_blackstone_bricks");
	polishedBlackstoneBricks = (new Tile(386, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("polishedBlackstoneBricks")->setAllFacesTexture("polished_blackstone_bricks");
	polishedDeepslateSlab = (new Tile(387, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("polishedDeepslateSlab")->setAllFacesTexture("polished_deepslate");
	polishedDeepslateStairs = (new Tile(388, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("polishedDeepslateStairs")->setAllFacesTexture("polished_deepslate");
	polishedDeepslateWall = (new Tile(389, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("polishedDeepslateWall")->setAllFacesTexture("polished_deepslate");
	polishedTuff = (new Tile(390, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("polishedTuff")->setAllFacesTexture("polished_tuff");
	polishedTuffSlab = (new Tile(391, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("polishedTuffSlab")->setAllFacesTexture("polished_tuff");
	potentSulfur = (new Tile(392, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("potentSulfur")->setAllFacesTexture("potent_sulfur");
	powderSnow = (new Tile(393, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("powderSnow")->setAllFacesTexture("powder_snow");
	poweredComparator = (new Tile(394, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("poweredComparator")->setAllFacesTexture("comparator_on");
	poweredRepeater = (new Tile(395, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("poweredRepeater")->setAllFacesTexture("repeater_on");
	prismarine = (new Tile(396, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("prismarine")->setAllFacesTexture("prismarine_bricks");
	purpleCarpet = (new Tile(397, 0, Material::cloth))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_CLOTH)->setCategory(ItemCategory::Decorations)->setDescriptionId("purpleCarpet")->setAllFacesTexture("stone");
	purpleGlazedTerracotta = (new Tile(398, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("purpleGlazedTerracotta")->setAllFacesTexture("stone");
	purpurBlock = (new Tile(399, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("purpurBlock")->setAllFacesTexture("purpur_block");
	purpurPillar = (new Tile(400, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("purpurPillar")->setAllFacesTexture("purpur_pillar");
	purpurSlab = (new Tile(401, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("purpurSlab")->setAllFacesTexture("purpur_block");
	purpurStairs = (new Tile(402, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("purpurStairs")->setAllFacesTexture("purpur_block");
	redCandle = (new Tile(403, 0, Material::plant))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_WOOD)->setCategory(ItemCategory::Decorations)->setDescriptionId("redCandle")->setLightEmission(3 / 16.0f)->setAllFacesTexture("red_candle");
	redCarpet = (new Tile(404, 0, Material::cloth))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_CLOTH)->setCategory(ItemCategory::Decorations)->setDescriptionId("redCarpet")->setAllFacesTexture("stone");
	redConcrete = (new Tile(405, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("redConcrete")->setAllFacesTexture("stone");
	redGlazedTerracotta = (new Tile(406, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("redGlazedTerracotta")->setAllFacesTexture("stone");
	redstoneBlock = (new Tile(407, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("redstoneBlock")->setAllFacesTexture("redstone_block");
	redstoneLamp = (new Tile(408, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("redstoneLamp")->setAllFacesTexture("redstone_lamp_off");
	redstoneTorch = (new Tile(409, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("redstoneTorch")->setAllFacesTexture("redstone_torch_on");
	redstoneWire = (new Tile(410, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("redstoneWire")->setAllFacesTexture("redstone_dust_cross");
	reinforcedDeepslate = (new Tile(411, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("reinforcedDeepslate")->setAllFacesTexture("deepslate");
	sandstoneWall = (new Tile(412, 0, Material::sand))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_SAND)->setCategory(ItemCategory::Decorations)->setDescriptionId("sandstoneWall")->setAllFacesTexture("sandstone_normal");
	sculkSensor = (new Tile(413, 0, Material::plant))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_GRASS)->setCategory(ItemCategory::Decorations)->setDescriptionId("sculkSensor")->setLightEmission(1 / 16.0f)->setAllFacesTexture("calibrated_sculk_sensor_amethyst");
	seaLantern = (new Tile(414, 0, Material::metal))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_METAL)->setCategory(ItemCategory::Decorations)->setDescriptionId("seaLantern")->setLightEmission(1.0f)->setAllFacesTexture("sea_lantern");
	seaPickle = (new Tile(415, 0, Material::plant))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_GRASS)->setCategory(ItemCategory::Decorations)->setDescriptionId("seaPickle")->setLightEmission(6 / 16.0f)->setAllFacesTexture("sea_pickle");
	silverGlazedTerracotta = (new Tile(416, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("silverGlazedTerracotta")->setAllFacesTexture("stone");
	skeletonSkull = (new Tile(417, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("skeletonSkull")->setAllFacesTexture("stone");
	smithingTable = (new Tile(418, 0, Material::wood))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_WOOD)->setCategory(ItemCategory::FoodArmor)->setDescriptionId("smithingTable")->setAllFacesTexture("smithing_table_bottom");
	smoker = (new Tile(419, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("smoker")->setAllFacesTexture("smoker_bottom");
	smoothBasalt = (new Tile(420, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("smoothBasalt")->setAllFacesTexture("smooth_basalt");
	smoothQuartz = (new Tile(421, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("smoothQuartz")->setAllFacesTexture("stone");
	smoothQuartzSlab = (new Tile(422, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("smoothQuartzSlab")->setAllFacesTexture("stone");
	smoothSandstone = (new Tile(423, 0, Material::sand))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_SAND)->setCategory(ItemCategory::Decorations)->setDescriptionId("smoothSandstone")->setAllFacesTexture("smooth_sandstone");
	smoothSandstoneDoubleSlab = (new Tile(424, 0, Material::sand))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_SAND)->setCategory(ItemCategory::Decorations)->setDescriptionId("smoothSandstoneDoubleSlab")->setAllFacesTexture("sandstone_top");
	smoothSandstoneSlab = (new Tile(425, 0, Material::sand))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_SAND)->setCategory(ItemCategory::Decorations)->setDescriptionId("smoothSandstoneSlab")->setAllFacesTexture("sandstone_top");
	smoothSandstoneStairs = (new Tile(426, 0, Material::sand))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_SAND)->setCategory(ItemCategory::Decorations)->setDescriptionId("smoothSandstoneStairs")->setAllFacesTexture("sandstone_top");
	smoothStone = (new Tile(427, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("smoothStone")->setAllFacesTexture("smooth_stone");
	smoothStoneDoubleSlab = (new Tile(428, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("smoothStoneDoubleSlab")->setAllFacesTexture("smooth_stone");
	smoothStoneSlab = (new Tile(429, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("smoothStoneSlab")->setAllFacesTexture("smooth_stone");
	soulFire = (new Tile(430, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("soulFire")->setAllFacesTexture("soul_fire_0");
	soulLantern = (new Tile(431, 0, Material::metal))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_METAL)->setCategory(ItemCategory::Decorations)->setDescriptionId("soulLantern")->setLightEmission(10 / 16.0f)->setAllFacesTexture("soul_lantern");
	spruceDoor = (new Tile(432, 0, Material::wood))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_WOOD)->setCategory(ItemCategory::Structures)->setDescriptionId("spruceDoor")->setAllFacesTexture("door_spruce_lower");
	sprucePressurePlate = (new Tile(433, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("sprucePressurePlate")->setAllFacesTexture("planks_spruce");
	spruceTrapdoor = (new Tile(434, 0, Material::wood))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_WOOD)->setCategory(ItemCategory::Structures)->setDescriptionId("spruceTrapdoor")->setAllFacesTexture("spruce_trapdoor");
	spruceWallSign = (new Tile(435, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("spruceWallSign")->setAllFacesTexture("planks_spruce");
	spruceWood = (new Tile(436, 0, Material::wood))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_WOOD)->setCategory(ItemCategory::Structures)->setDescriptionId("spruceWood")->setAllFacesTexture("stone");
	stickyPiston = (new Tile(437, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("stickyPiston")->setAllFacesTexture("piston_top_sticky");
	stickyPistonArmCollision = (new Tile(438, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("stickyPistonArmCollision")->setAllFacesTexture("piston_top_sticky");
	stoneBrickWall = (new Tile(439, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("stoneBrickWall")->setAllFacesTexture("stone_brick");
	stoneButton = (new Tile(440, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("stoneButton")->setAllFacesTexture("stone");
	stonePressurePlate = (new Tile(441, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("stonePressurePlate")->setAllFacesTexture("stone");
	strippedAcaciaLog = (new Tile(442, 0, Material::wood))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_WOOD)->setCategory(ItemCategory::Decorations)->setDescriptionId("strippedAcaciaLog")->setAllFacesTexture("stripped_acacia_log");
	strippedOakLog = (new Tile(443, 0, Material::wood))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_WOOD)->setCategory(ItemCategory::Decorations)->setDescriptionId("strippedOakLog")->setAllFacesTexture("stripped_oak_log");
	strippedOakWood = (new Tile(444, 0, Material::wood))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_WOOD)->setCategory(ItemCategory::Structures)->setDescriptionId("strippedOakWood")->setAllFacesTexture("stone");
	strippedSpruceLog = (new Tile(445, 0, Material::wood))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_WOOD)->setCategory(ItemCategory::Decorations)->setDescriptionId("strippedSpruceLog")->setAllFacesTexture("stripped_spruce_log");
	strippedSpruceWood = (new Tile(446, 0, Material::wood))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_WOOD)->setCategory(ItemCategory::Structures)->setDescriptionId("strippedSpruceWood")->setAllFacesTexture("stone");
	structureBlock = (new Tile(447, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("structureBlock")->setAllFacesTexture("structure_block_corner");
	sulfur = (new Tile(448, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("sulfur")->setAllFacesTexture("sand");
	sulfurSpike = (new Tile(449, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("sulfurSpike")->setAllFacesTexture("sandstone_top");
	tallGrass = (new FlowerTile(450, 0))->init()->setCategory(ItemCategory::Decorations)->setDescriptionId("tallGrass")->setAllFacesTexture("double_plant_grass_top");
	target = (new Tile(451, 0, Material::plant))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_WOOD)->setCategory(ItemCategory::Decorations)->setDescriptionId("target")->setAllFacesTexture("target_side");
	trappedChest = (new Tile(452, 0, Material::wood))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_WOOD)->setCategory(ItemCategory::FoodArmor)->setDescriptionId("trappedChest")->setAllFacesTexture("trapped_chest_front");
	trialSpawner = (new Tile(453, 0, Material::metal))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_METAL)->setCategory(ItemCategory::Decorations)->setDescriptionId("trialSpawner")->setAllFacesTexture("trial_spawner_bottom");
	tripWire = (new Tile(454, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("tripWire")->setAllFacesTexture("trip_wire");
	tripwireHook = (new Tile(455, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("tripwireHook")->setAllFacesTexture("trip_wire_source");
	tuff = (new Tile(456, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("tuff")->setAllFacesTexture("tuff");
	tuffBricks = (new Tile(457, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("tuffBricks")->setAllFacesTexture("tuff_bricks");
	unlitRedstoneTorch = (new Tile(458, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("unlitRedstoneTorch")->setLightEmission(1.0f)->setAllFacesTexture("redstone_torch_off");
	unpoweredComparator = (new Tile(459, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("unpoweredComparator")->setAllFacesTexture("comparator_off");
	unpoweredRepeater = (new Tile(460, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("unpoweredRepeater")->setAllFacesTexture("repeater_off");
	vault = (new Tile(461, 0, Material::metal))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_METAL)->setCategory(ItemCategory::Decorations)->setDescriptionId("vault")->setAllFacesTexture("vault_bottom");
	wallBanner = (new Tile(462, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("wallBanner")->setAllFacesTexture("wool_colored_white");
	waxedChiseledCopper = (new Tile(463, 0, Material::metal))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_METAL)->setCategory(ItemCategory::Structures)->setDescriptionId("waxedChiseledCopper")->setAllFacesTexture("chiseled_copper");
	waxedCopper = (new Tile(464, 0, Material::metal))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_METAL)->setCategory(ItemCategory::Structures)->setDescriptionId("waxedCopper")->setAllFacesTexture("waxed_copper");
	waxedCopperBulb = (new Tile(465, 0, Material::metal))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_METAL)->setCategory(ItemCategory::Structures)->setDescriptionId("waxedCopperBulb")->setLightEmission(1.0f)->setAllFacesTexture("copper_bulb");
	waxedCopperDoor = (new Tile(466, 0, Material::wood))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_WOOD)->setCategory(ItemCategory::Structures)->setDescriptionId("waxedCopperDoor")->setAllFacesTexture("copper_door_bottom");
	waxedCopperGrate = (new Tile(467, 0, Material::metal))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_METAL)->setCategory(ItemCategory::Structures)->setDescriptionId("waxedCopperGrate")->setAllFacesTexture("copper_grate");
	waxedCutCopper = (new Tile(468, 0, Material::metal))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_METAL)->setCategory(ItemCategory::Structures)->setDescriptionId("waxedCutCopper")->setAllFacesTexture("waxed_cut_copper");
	waxedCutCopperSlab = (new Tile(469, 0, Material::metal))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_METAL)->setCategory(ItemCategory::Structures)->setDescriptionId("waxedCutCopperSlab")->setAllFacesTexture("cut_copper");
	waxedCutCopperStairs = (new Tile(470, 0, Material::metal))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_METAL)->setCategory(ItemCategory::Structures)->setDescriptionId("waxedCutCopperStairs")->setAllFacesTexture("cut_copper");
	waxedOxidizedChiseledCopper = (new Tile(471, 0, Material::metal))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_METAL)->setCategory(ItemCategory::Structures)->setDescriptionId("waxedOxidizedChiseledCopper")->setAllFacesTexture("oxidized_chiseled_copper");
	waxedOxidizedCopper = (new Tile(472, 0, Material::metal))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_METAL)->setCategory(ItemCategory::Structures)->setDescriptionId("waxedOxidizedCopper")->setAllFacesTexture("oxidized_copper");
	waxedOxidizedCopperDoor = (new Tile(473, 0, Material::wood))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_WOOD)->setCategory(ItemCategory::Structures)->setDescriptionId("waxedOxidizedCopperDoor")->setAllFacesTexture("oxidized_copper_door_bottom");
	waxedOxidizedCopperGrate = (new Tile(474, 0, Material::metal))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_METAL)->setCategory(ItemCategory::Structures)->setDescriptionId("waxedOxidizedCopperGrate")->setAllFacesTexture("oxidized_copper_grate");
	waxedOxidizedCopperTrapdoor = (new Tile(475, 0, Material::wood))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_WOOD)->setCategory(ItemCategory::Structures)->setDescriptionId("waxedOxidizedCopperTrapdoor")->setAllFacesTexture("oxidized_copper_trapdoor");
	waxedOxidizedCutCopper = (new Tile(476, 0, Material::metal))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_METAL)->setCategory(ItemCategory::Structures)->setDescriptionId("waxedOxidizedCutCopper")->setAllFacesTexture("oxidized_cut_copper");
	waxedOxidizedCutCopperSlab = (new Tile(477, 0, Material::metal))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_METAL)->setCategory(ItemCategory::Structures)->setDescriptionId("waxedOxidizedCutCopperSlab")->setAllFacesTexture("oxidized_cut_copper");
	waxedOxidizedCutCopperStairs = (new Tile(478, 0, Material::metal))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_METAL)->setCategory(ItemCategory::Structures)->setDescriptionId("waxedOxidizedCutCopperStairs")->setAllFacesTexture("oxidized_cut_copper");
	whiteCandle = (new Tile(479, 0, Material::plant))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_WOOD)->setCategory(ItemCategory::Decorations)->setDescriptionId("whiteCandle")->setLightEmission(3 / 16.0f)->setAllFacesTexture("white_candle");
	whiteCarpet = (new Tile(480, 0, Material::cloth))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_CLOTH)->setCategory(ItemCategory::Decorations)->setDescriptionId("whiteCarpet")->setAllFacesTexture("stone");
	whiteConcrete = (new Tile(481, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("whiteConcrete")->setAllFacesTexture("stone");
	whiteGlazedTerracotta = (new Tile(482, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("whiteGlazedTerracotta")->setAllFacesTexture("stone");
	whiteStainedGlass = (new Tile(483, 0, Material::glass))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_GLASS)->setCategory(ItemCategory::Decorations)->setDescriptionId("whiteStainedGlass")->setAllFacesTexture("glass");
	whiteStainedGlassPane = (new Tile(484, 0, Material::glass))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_GLASS)->setCategory(ItemCategory::Structures)->setDescriptionId("whiteStainedGlassPane")->setAllFacesTexture("glass");
	woodenButton = (new Tile(485, 0, Material::wood))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_WOOD)->setCategory(ItemCategory::Structures)->setDescriptionId("woodenButton")->setAllFacesTexture("planks_oak");
	woodenPressurePlate = (new Tile(486, 0, Material::wood))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_WOOD)->setCategory(ItemCategory::Structures)->setDescriptionId("woodenPressurePlate")->setAllFacesTexture("planks_oak");
	yellowCarpet = (new Tile(487, 0, Material::cloth))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_CLOTH)->setCategory(ItemCategory::Decorations)->setDescriptionId("yellowCarpet")->setAllFacesTexture("stone");
	yellowGlazedTerracotta = (new Tile(488, 0, Material::stone))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_STONE)->setCategory(ItemCategory::Structures)->setDescriptionId("yellowGlazedTerracotta")->setAllFacesTexture("stone");
	yellowStainedGlassPane = (new Tile(489, 0, Material::glass))->init()->setDestroyTime(1.5f)->setSoundType(SOUND_GLASS)->setCategory(ItemCategory::Structures)->setDescriptionId("yellowStainedGlassPane")->setAllFacesTexture("glass");
}
