...
void Item::initItems() {
	...
	Item::coal = (new CoalItem(7))->setIcon(7, 0)->setCategory(ItemCategory::FoodArmor)->setDescriptionId("coal");
	Item::emerald = (new Item(8))->setIcon(7, 3)->setCategory(ItemCategory::FoodArmor)->setDescriptionId("emerald");
	Item::ironIngot = (new Item(9))->setIcon(7, 1)->setCategory(ItemCategory::FoodArmor)->setDescriptionId("ingotIron");
	Item::goldIngot = (new Item(10))->setIcon(7, 2)->setCategory(ItemCategory::FoodArmor)->setDescriptionId("ingotGold");
	...
	Item::stick = (new Item(24))->setIcon(5, 3)->handEquipped()->setCategory(ItemCategory::FoodArmor)->setDescriptionId("stick");
	...
	Item::string = (new Item(31))->setIcon(8, 0)->setCategory(ItemCategory::FoodArmor)->setDescriptionId("string");
	Item::feather = (new Item(32))->setIcon(8, 1)->setCategory(ItemCategory::FoodArmor)->setDescriptionId("feather");
	Item::sulphur = (new Item(33))->setIcon(8, 2)->setCategory(ItemCategory::FoodArmor)->setDescriptionId("sulphur");
	...
	Item::seeds_wheat = (new SeedItem(39, Tile::crops->id, Tile::farmland->id))->setIcon(9, 0)->setCategory(ItemCategory::Decorations)->setDescriptionId("seeds");
	...
	Item::helmet_cloth     = (new ArmorItem(42, ArmorItem::CLOTH, 0, ArmorItem::SLOT_HEAD))->setIcon(0, 0)->setCategory(ItemCategory::Tools)->setDescriptionId("helmetCloth");
	Item::chestplate_cloth = (new ArmorItem(43, ArmorItem::CLOTH, 0, ArmorItem::SLOT_TORSO))->setIcon(0, 1)->setCategory(ItemCategory::Tools)->setDescriptionId("chestplateCloth");
	Item::leggings_cloth   = (new ArmorItem(44, ArmorItem::CLOTH, 0, ArmorItem::SLOT_LEGS))->setIcon(0, 2)->setCategory(ItemCategory::Tools)->setDescriptionId("leggingsCloth");
	Item::boots_cloth      = (new ArmorItem(45, ArmorItem::CLOTH, 0, ArmorItem::SLOT_FEET))->setIcon(0, 3)->setCategory(ItemCategory::Tools)->setDescriptionId("bootsCloth");

	Item::helmet_chain     = (new ArmorItem(46, ArmorItem::CHAIN, 1, ArmorItem::SLOT_HEAD))->setIcon(1, 0)->setCategory(ItemCategory::Tools)->setDescriptionId("helmetChain");
	Item::chestplate_chain = (new ArmorItem(47, ArmorItem::CHAIN, 1, ArmorItem::SLOT_TORSO))->setIcon(1, 1)->setCategory(ItemCategory::Tools)->setDescriptionId("chestplateChain");
	Item::leggings_chain   = (new ArmorItem(48, ArmorItem::CHAIN, 1, ArmorItem::SLOT_LEGS))->setIcon(1, 2)->setCategory(ItemCategory::Tools)->setDescriptionId("leggingsChain");
	Item::boots_chain      = (new ArmorItem(49, ArmorItem::CHAIN, 1, 3))->setIcon(1, 3)->setCategory(ItemCategory::Tools)->setDescriptionId("bootsChain");

	Item::helmet_iron      = (new ArmorItem(50, ArmorItem::IRON, 2, ArmorItem::SLOT_HEAD))->setIcon(2, 0)->setCategory(ItemCategory::Tools)->setDescriptionId("helmetIron");
	Item::chestplate_iron  = (new ArmorItem(51, ArmorItem::IRON, 2, ArmorItem::SLOT_TORSO))->setIcon(2, 1)->setCategory(ItemCategory::Tools)->setDescriptionId("chestplateIron");
	Item::leggings_iron    = (new ArmorItem(52, ArmorItem::IRON, 2, ArmorItem::SLOT_LEGS))->setIcon(2, 2)->setCategory(ItemCategory::Tools)->setDescriptionId("leggingsIron");
	Item::boots_iron       = (new ArmorItem(53, ArmorItem::IRON, 2, ArmorItem::SLOT_FEET))->setIcon(2, 3)->setCategory(ItemCategory::Tools)->setDescriptionId("bootsIron");

	Item::helmet_diamond   = (new ArmorItem(54, ArmorItem::DIAMOND, 3, ArmorItem::SLOT_HEAD))->setIcon(3, 0)->setCategory(ItemCategory::Tools)->setDescriptionId("helmetDiamond");
	Item::chestplate_diamond=(new ArmorItem(55, ArmorItem::DIAMOND, 3, ArmorItem::SLOT_TORSO))->setIcon(3, 1)->setCategory(ItemCategory::Tools)->setDescriptionId("chestplateDiamond");
	Item::leggings_diamond = (new ArmorItem(56, ArmorItem::DIAMOND, 3, ArmorItem::SLOT_LEGS))->setIcon(3, 2)->setCategory(ItemCategory::Tools)->setDescriptionId("leggingsDiamond");
	Item::boots_diamond    = (new ArmorItem(57, ArmorItem::DIAMOND, 3, ArmorItem::SLOT_FEET))->setIcon(3, 3)->setCategory(ItemCategory::Tools)->setDescriptionId("bootsDiamond");

	Item::helmet_gold      = (new ArmorItem(58, ArmorItem::GOLD, 4, ArmorItem::SLOT_HEAD))->setIcon(4, 0)->setCategory(ItemCategory::Tools)->setDescriptionId("helmetGold");
	Item::chestplate_gold  = (new ArmorItem(59, ArmorItem::GOLD, 4, ArmorItem::SLOT_TORSO))->setIcon(4, 1)->setCategory(ItemCategory::Tools)->setDescriptionId("chestplateGold");
	Item::leggings_gold    = (new ArmorItem(60, ArmorItem::GOLD, 4, ArmorItem::SLOT_LEGS))->setIcon(4, 2)->setCategory(ItemCategory::Tools)->setDescriptionId("leggingsGold");
	Item::boots_gold       = (new ArmorItem(61, ArmorItem::GOLD, 4, ArmorItem::SLOT_FEET))->setIcon(4, 3)->setCategory(ItemCategory::Tools)->setDescriptionId("bootsGold");

	Item::flint = (new Item(62))->setIcon(6, 0)->setCategory(ItemCategory::FoodArmor)->setDescriptionId("flint");
	...
	Item::painting = (new HangingEntityItem(65, EntityTypes::IdPainting))->setIcon(10, 1)->setCategory(ItemCategory::FoodArmor)->setDescriptionId("painting");
	//Item::apple_gold = (new FoodItem(66, 42, false))->setIcon(11, 0)->setCategory(ItemCategory::FoodArmor)->setDescriptionId("appleGold");
	Item::sign = (new SignItem(67))->setIcon(10, 2)->setCategory(ItemCategory::FoodArmor)->setDescriptionId("sign");
	...
	Item::snowBall = (new SnowballItem(76))->setIcon(14, 0)->setCategory(ItemCategory::FoodArmor)->setDescriptionId("snowball");
	//Item::boat = (new BoatItem(77))->setIcon(8, 8)->setCategory(ItemCategory::Mechanisms)->setDescriptionId("boat");
	Item::leather = (new Item(78))->setIcon(7, 6)->setCategory(ItemCategory::FoodArmor)->setDescriptionId("leather");
	Item::milk = (new BucketItem(79, -1))->setMaxStackSize(1)->setIcon(13, 4)->setCategory(ItemCategory::Tools)->setDescriptionId("milk")->setCraftingRemainingItem(Item::bucket_empty);
	Item::brick = (new Item(80))->setIcon(6, 1)->setCategory(ItemCategory::FoodArmor)->setDescriptionId("brick");
	Item::clay = (new Item(81))->setIcon(9, 3)->setCategory(ItemCategory::FoodArmor)->setDescriptionId("clay");
	Item::reeds = (new TilePlanterItem(82, Tile::reeds))->setIcon(11, 1)->setCategory(ItemCategory::Decorations)->setDescriptionId("reeds");
	Item::paper = (new Item(83))->setIcon(10, 3)->setCategory(ItemCategory::FoodArmor)->setDescriptionId("paper");
	Item::book = (new Item(84))->setIcon(11, 3)->setCategory(ItemCategory::FoodArmor)->setDescriptionId("book");
	Item::slimeBall = (new Item(85))->setIcon(14, 1)->setCategory(ItemCategory::FoodArmor)->setDescriptionId("slimeball");
	...
	Item::yellowDust = (new Item(92))->setIcon(9, 4)->setCategory(ItemCategory::FoodArmor)->setDescriptionId("yellowDust");
	...
	Item::dye_powder = (new DyePowderItem(95))->setIcon(14, 4)->setCategory(ItemCategory::FoodArmor)->setDescriptionId("dyePowder");
	Item::bone = (new Item(96))->setIcon(12, 1)->setCategory(ItemCategory::FoodArmor)->setDescriptionId("bone")->handEquipped();
	...
	Item::bed = (new BedItem(99))->setMaxStackSize(1)->setIcon(13, 2)->setCategory(ItemCategory::FoodArmor)->setDescriptionId("bed");
	...
	Item::seeds_melon = (new SeedItem(106, Tile::melonStem->id, Tile::farmland->id))->setIcon(14, 3)->setCategory(ItemCategory::Decorations)->setDescriptionId("seedsMelon");
	...
	Item::camera = (new CameraItem(200))->setIcon(2, 15)->setCategory(ItemCategory::FoodArmor)->setDescriptionId("camera");
